APEON ProjectThis repository contains the files and code for the APEON project. Below is an explanation of the directory structure and the contents of each folder.Directory Structure.
├── APEON.pptx
├── Dataset/
